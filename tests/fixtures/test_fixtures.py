...
def messy_data_df():
    ...
    return pd.DataFrame({
        ...
        "percentage": [50, 80, 110, -10, 150, 55, 85, 95, 105, 200],  # Out of 0-100 range
    })
...
def extreme_values_df():
    ...
    return pd.DataFrame({
        ...
        "tiny_values": [1e-10, 2e-10, 3e-10, 4e-10, 5e-10, 6e-10, 7e-10, 8e-10, 9e-10, 1e-9],
...
def range_check_config():
    ...
    return {
        ...
        "score": {
            "min_value": 1,
            "max_value": 5,
            "description": "Score should be 1-5"
        }
    }
...
def edge_case_configs():
    ...
    return {
        ...
        "extreme_threshold_config": {
            "value": {
                "thresholds": {"absolute_critical": 1e10}
            }
        }
    }
