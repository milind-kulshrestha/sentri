...
class TestDriftCheck:
    ...
    def test_drift_check_no_drift(self, drift_config):
        ...
        assert result.iloc[0]['additional_metrics']['interpretation'] == 'No significant drift'
    ...
    def test_drift_check_insufficient_data(self, drift_config):
        ...
        assert not result.empty
        assert result.iloc[0]['status'] == CheckStatus.PASS
        assert 'Insufficient data for PSI' in result.iloc[0]['additional_metrics']['message']
