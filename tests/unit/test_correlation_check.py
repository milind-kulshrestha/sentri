...
from tests.fixtures.test_fixtures import (
    basic_df, multi_date_df, correlation_test_df, temporal_drift_df,
    correlation_config, temporal_correlation_config, edge_case_configs
)
...
class TestCorrelationCheck:
    ...
    def sample_df(self):
        ...
        return pd.DataFrame({
            ...
            "value1": [10, 20, 30, 40, 50, 12, 22, 32, 42, 52],  # Highly correlated with value2
            "value2": [15, 25, 35, 45, 55, 17, 27, 37, 47, 57],  # Highly correlated with value1
    ...
    def test_correlation_check_insufficient_matching_records(self):
        ...
        assert results.iloc[0]["status"] == CheckStatus.PASS
        assert results.iloc[0]["metric_value"] == 1.0
        assert "Insufficient matching records" in results.iloc[0]["additional_metrics"]["message"]
    ...
    def test_correlation_with_shared_fixtures(self, correlation_test_df, correlation_config):
    ...
    def test_temporal_correlation_with_drift(self, temporal_drift_df, temporal_correlation_config):
